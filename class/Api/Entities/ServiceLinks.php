...
class ServiceLinks {
     ...
     * @return false|string
     */
    public static function hsl_directions_link( string $street_address = null, string $city = null ) : string {
     ...
     * @return false|string
     */
    public static function google_directions_link( string $street_address = null, string $city = null ) : string {
        return sprintf(
     ...
     * @return null|string
     */
    public static function google_maps_link( array $address_pieces ) : ?string {
